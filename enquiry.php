...
<body>      
  ...
  <tbody>
    <tr>
      <td vAlign='top' style='background-color:#222a35; padding:10px;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:16px; color:#ffffff; text-align:center; font-weight:bold;' colspan='3' >Enquiry From <b style='color:white;'>$name</b></td>
    </tr>
<tr>
      ...
      <main>
		...
		<div class="container">
				  <div class="row">
                     ...
                     <div class="col-md-5">
                         <img src="<?=$baseurl?>/img/enquiry.png" class="img-thumbnail" style="width:100%;">
                     </div>
